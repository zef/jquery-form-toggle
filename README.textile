...
You can also pass callbacks and custom options when you setup the form_toggle. See the code for details.

h3. "View Demo":http://madebykiwi.com/dev_center/jquery_form_toggle
