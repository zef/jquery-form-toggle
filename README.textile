...
Use the class <pre>toggle</pre> class on any radio button, or select element and elements with a class corresponding to the button or select value will be hidden and shown with the selection of a value.

For checkboxes, the class <pre>toggle-some_class</pre> would tie the checkbox to elements with class <pre>some_class</pre>.
...
This will use the <pre>opposite</pre> class, and the effect will be reversed.
